...
case TRANSACTION_GetAllScan_Results:
{
data.enforceInterface(DESCRIPTOR);
java.util.List<java.lang.String> _result = this.GetAllScan_Results();
reply.writeNoException();
reply.writeStringList(_result);
return true;
}
...
case TRANSACTION_Tag_Request_Send:
{
data.enforceInterface(DESCRIPTOR);
int _arg0;
_arg0 = data.readInt();
this.Tag_Request_Send(_arg0);
reply.writeNoException();
return true;
}
}
...
@Override public java.util.List<java.lang.String> GetAllScan_Results() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
java.util.List<java.lang.String> _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_GetAllScan_Results, _data, _reply, 0);
_reply.readException();
_result = _reply.createStringArrayList();
}
finally {
...
@Override public void Tag_Request_Send(int selected_player) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeInt(selected_player);
mRemote.transact(Stub.TRANSACTION_Tag_Request_Send, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
static final int TRANSACTION_GetAllScan_Results = (android.os.IBinder.FIRST_CALL_TRANSACTION + 3);
static final int TRANSACTION_Tag = (android.os.IBinder.FIRST_CALL_TRANSACTION + 4);
static final int TRANSACTION_Tag_Request_Send = (android.os.IBinder.FIRST_CALL_TRANSACTION + 5);
}
...
public java.util.List<java.lang.String> GetAllScan_Results() throws android.os.RemoteException;
public boolean Tag(int selected_player) throws android.os.RemoteException;
public void Tag_Request_Send(int selected_player) throws android.os.RemoteException;
}
